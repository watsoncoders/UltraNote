...
//   } else {
 ...
 //	std::cout << "Modify this line into your UltraNote configuration file as is:  " << std::endl;
 //	std::cout << "const char GENESIS_COINBASE_TX_HEX[] = \"" << tx_hex << "\";" << std::endl;
//   }
//   return;
// }
